...
<center>
Good programming means <p style="color:red"> Work efficiency</p> 
</center>
...
<span style="color: blue;">**it is completely fine.**<span/>
...
```{r fig0, out.width='90%', fig.align='center', fig.pos='h', fig.cap='',echo = FALSE}

    knitr::include_graphics("/img/ugly_code_run.png", error = FALSE)
